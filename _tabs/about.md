...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:20px;align-items:center;justify-items:center;">
	...
	<div style="display:flex;align-items:center;justify-content:center;min-height:220px;">
		<img src="/assets/img/certifications/ai-trainer-fundamentals.png" alt="Microsoft Applied Skills AI Trainer Fundamentals" loading="lazy" style="width:180px;height:180px;object-fit:contain;">
	</div>
	<div style="display:flex;align-items:center;justify-content:center;min-height:220px;">
		<img src="/assets/img/certifications/azure-ai-engineer-associate.png" alt="Microsoft Certified Azure AI Engineer Associate" loading="lazy" style="width:180px;height:180px;object-fit:contain;">
	</div>
	<div style="display:flex;align-items:center;justify-content:center;min-height:220px;">
		<img src="/assets/img/certifications/azure-ai-fundamentals.png" alt="Microsoft Certified Azure AI Fundamentals" loading="lazy" style="width:180px;height:180px;object-fit:contain;">
	</div>
	<div style="display:flex;align-items:center;justify-content:center;min-height:220px;">
		<img src="/assets/img/certifications/power-platform-solutions-architect-expert.png" alt="Microsoft Certified Power Platform Solutions Architect Expert" loading="lazy" style="width:180px;height:180px;object-fit:contain;">
	</div>
	<div style="display:flex;align-items:center;justify-content:center;min-height:220px;">
		<img src="/assets/img/certifications/power-platform-developer-associate.png" alt="Microsoft Certified Power Platform Developer Associate" loading="lazy" style="width:180px;height:180px;object-fit:contain;">
	</div>
	<div style="display:flex;align-items:center;justify-content:center;min-height:220px;">
